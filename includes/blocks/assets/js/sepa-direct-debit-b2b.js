...
const sepaDirectDebitB2BContent = (props) => {
    ...
    return React.createElement('div', null,
        React.createElement('div', null,
            React.createElement('label', { htmlFor: 'betterpayment_dd_b2b_iban' }, betterpayment_dd_b2b_l10n.label_iban),
            ...
            React.createElement('br'),
            React.createElement('label', { htmlFor: 'betterpayment_dd_b2b_bic' }, betterpayment_dd_b2b_l10n.label_bic),
            React.createElement('br'),
            ...
            React.createElement('div', null,
                ...
                React.createElement('label', { htmlFor: 'betterpayment_dd_b2b_mandate_agreement' }, betterpayment_dd_b2b_l10n.label_mandate_agreement)
            )
        ),
        sepaDirectDebitB2BIsRiskCheckAgreementRequired && React.createElement('div', null,
            React.createElement('h4', null, betterpayment_dd_b2b_l10n.label_risk_check_information),
            ...
            React.createElement('label', { htmlFor: 'betterpayment_dd_b2b_risk_check_agreement' }, betterpayment_dd_b2b_l10n.label_risk_check_agreement)
        )
    );
};
